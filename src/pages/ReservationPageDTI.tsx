 ...
 * - Pode aprovar / rejeitar reservas individuais e em lote
 * - Acessa o Verificador de Grade
 *
 * DTI_ESTAGIARIO:
 * - Visualiza todas as reservas (somente leitura)
 * - Banner indicando modo de visualização
 * - Acessa o Verificador de Grade
 * - Sem botões de ação
 */
...
import {
  ...
  CalendarDays, Search, Building2, Monitor, Eye,
} from "lucide-react";
      ...
      <td className="px-6 py-4">
        ...
        <div className="flex gap-1.5 mt-1 flex-wrap">
          ...
          {r.requested_softwares && (
            <span className="text-[9px] font-bold bg-blue-50 text-blue-700 px-1.5 py-0.5 rounded border border-blue-200">Software</span>
          )}
        </div>
      </td>
...
export function ReservationPageDTI() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Banner de somente leitura para Estagiário */}
      {!canApprove && (
